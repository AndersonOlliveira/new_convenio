    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            align-items: center;
            background:
                radial-gradient(circle at top right, rgba(27, 181, 107, .12), transparent 28%),
        ...
        .badge {
            ...
            padding: 8px 14px;
            border-radius: 999px;
            background: rgba(27, 181, 107, .10);
            color: var(--secondary);
            border: 1px solid rgba(27, 181, 107, .18);
            margin-bottom: 18px;
            font-size: .92rem;
            font-weight: 700;
        }
    ...
    <main>
        ...
        <section id="planos">
            <div class="container">
                ...
                <p class="section-subtitle">
                    Você pode usar esta área para apresentar categorias de convênio, perfis de contratação ou faixas de atendimento.
                </p>
